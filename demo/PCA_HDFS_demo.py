...
if __name__ == '__main__':
    ...
    x_train = dataloader.load_HDFS_data_timestamp_approach(train_path, time_delta_sec=time_delta_sec,
                                                          ...
                                                          cached_workflow_path=r'..\cached\HDFS\train_workflow_100.csv')
    ...
    x_test = dataloader.load_HDFS_data_timestamp_approach(test_path, time_delta_sec=time_delta_sec,
                                                      timestamp_format='%Y-%m-%d %H:%M:%S',
    ...
    graphs_and_reports.get_anomalies_report(r'..\cached\HDFS\train_workflow.csv',
                                            r'../analysis_results/HDFS/key_dict.txt',
                                            prediction, r'..\analysis_results\HDFS\anomalies_report.txt',
                                            time_delta_sec=time_delta_sec)
    graphs_and_reports.get_graph(r'..\cached\HDFS\train_workflow.csv', prediction, model.threshold,
